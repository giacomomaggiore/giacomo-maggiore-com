---
date: '2026-06-09'
source: wiki/source/la_matematica_del_benessere_toia.pdf
title: La Matematica Del Benessere Toia
...
Non esaltato dai momenti belli, né schiacciato da quelli bruti. E lì ho capito qualcosa: la felicità non è uno stato, è una variazione. È una derivata.  
...
$$
\text{Felicità} (t, \omega) = \frac{\partial}{\partial t} [ \text{Benessere} (t) ] + \epsilon (t, \omega)
$$  

Il cervello sembra agire come un operatore differenziale, ma non solo.  

Essenzialmente il concetto è questo: se il benessere non cresce, la felicità è 0. Più  

velocemente cresce, più felice sei. Ma.  

Ma a questo va aggiunto un termine di errore, che dipende dal tempo, dalla nostra storia passata, e onestamente da qualcos'altro che non saprei nemmeno come formalizzare.  

Quel termine è il nostro "rumore emotivo": dipende dal tempo e dalla nostra storia passata.  

E quando la derivata si annulla – anche se sei "in alto" – resta solo quel termine di errore a guidare la percezione del benessere.  

Essenzialmente, aggiunge complessità. Come se non bastasse quella che c'era già.  

È l'adattamento edonico.  

La curva si stabilizza. La derivata diventa 0. E tu ti chiedi:  
...
Non viviamo mai solo nel momento presente. Anche quando tutto è perfetto, c'è una parte della mente che si confronta con ciò che è successo ieri, la settimana scorsa, o tre mesi fa.  
...
## S(t) = f (α<sub>0</sub>ω<sub>0</sub>, α<sub>1</sub>ω<sub>1</sub>, … , α<sub>t−1</sub>ω<sub>t−1</sub>)  

Dove ogni α<sub>i</sub> rappresenta un evento passato, e ogni ω<sub>i</sub> è il peso che gli diamo.  

Se fosse una media semplice, eventi più lontani peserebbero sempre meno. Ma non funziona.  

Perché ci sono periodi – alcuni giorni, alcune estati, certe settimane strane – che restano lì.  

Alcuni α<sub>i</sub> sono enormi, quella estate di tre anni fa? Quella settimana strana al liceo? Quel pomeriggio che non dovrebbe significare nulla? Hanno coefficienti inspiegabilmente alti.  

Altri α<sub>i</sub> sono quasi zero. Settimane intere della tua vita che pesano meno di un singolo momento. È come se il cervello avesse un algoritmo di pesatura completamente irrazionale.  

E il nostro livello di felicità? Dipende da quanto ci aspettiamo che questo stato migliorerà:  

$$
\text{Felicità} (t) \approx \mathbb{E} \left[ \frac{\partial S}{\partial t} \mid \alpha_{i} \omega_{i} \right]
$$  
...
Ma quei periodi con α<sub>i</sub> alti... erano davvero così belli?  

Voglio dire: quei periodi che ricordo come estremamente piacevoli, produttivi... lo erano?  

Se ci ripenso, spesso non me ne rendevo conto mentre li vivevo.  

Non dicevo: "questo sarà un momento importante" allora.  
...
"Ah, ecco cosa sta succedendo. Il mio cervello sta cercando variazioni che non ci sono.  

Sta confrontando questo momento con quell'estate del 2019 che ha un coefficiente α  
assurdamente alto."  
...
Il trucco funziona perché introduce una meta-derivata. Ma che c***o è una meta-derivata, dai...  
...
E in quel passaggio – tra la cognizione e la percezione – si gioca tutto: per un momento sei sia il grafico, sia chi sta guardando il grafico.  

## La trappola della stabilità  

La stabilità che tanto inseguiamo può diventare una trappola.  

Quando le cose si fermano – anche se in alto, anche se giuste – la mente smette di percepirle.  
...
Ero dentro un palazzo che anni prima fotografavo da fuori, da studente appena arrivato a Milano.  
...
E il cervello, che vive di \(\frac{\partial}{\partial t}\), ha smesso di restituirmi emozione.  
...
"La felicità è definibile anche come la derivata prima del benessere."  
...
Perché tutto ciò che abbiamo ottenuto, che volevamo, che desideravamo… ora è solo il nostro.  

Il cervello ci frega.  

È il nostro sistema operativo, eppure ci mette in trappola. E il punto è che non possiamo.  
...
È successo qualche giorno fa. Ero seduto al bar sotto casa, niente di speciale. Caffè caldo, telefono in mano, rumore di traffico. La giornata uguale a mille altre. Il mio cervello, fedele alla sua natura, già iniziato a cercare: "Ok, e ora? Cosa c'è dopo?"  

E poi, per qualche secondo, mi sono fermato.  

Ho pensato: "Non sta succedendo nulla di straordinario... eppure questo è esattamente dove voglio essere."  

Non era felicità. Era qualcosa di più sottile: presenza.  

Il trucco non è convincere il cervello che tutto va bene. È accorgersi che il cervello sta facendo quello che sa fare – confrontare, misurare, cercare variazioni – senza lasciarsi trascinare dal flusso.  

Tu rimani lì, a guardare. Senza giudicare la corrente, senza volerla cambiare.  
