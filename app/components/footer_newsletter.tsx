...
export default function Footer() {
  return (
    <footer className="mb-10 mt-8">
      <form
        action="https://YOUR_PROVIDER_SUBSCRIBE_ENDPOINT"
        method="POST"
        target="_blank"
        className="mb-6 rounded-lg border border-neutral-200 dark:border-neutral-800 p-4"
      >
        <p className="text-sm font-medium text-neutral-900 dark:text-neutral-100">
          Newsletter
        </p>
        <p className="mt-1 text-xs text-neutral-600 dark:text-neutral-400">
          One email when I publish something new. No spam.
        </p>
        ...
        <div className="mt-3 flex flex-col gap-2 sm:flex-row">
          ...
          <button
            type="submit"
            className="rounded-md bg-neutral-900 px-4 py-2 text-sm text-neutral-50 transition-colors hover:bg-neutral-700 dark:bg-neutral-100 dark:text-neutral-900 dark:hover:bg-neutral-300"
          >
            Subscribe
          </button>
        </div>
        ...
        <label className="mt-3 flex items-start gap-2 text-xs text-neutral-600 dark:text-neutral-400">
          <input
            ...
            value="yes"
            required
            className="mt-0.5 h-4 w-4 rounded border-neutral-300 bg-transparent dark:border-neutral-700"
          />
          <span>
            I agree to receive newsletter emails and I have read the Privacy Policy.
          </span>
        </label>
      </form>
